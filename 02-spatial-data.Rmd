...
(ref:x-fig) the work of @akima_akima_2016. use the code `x<-3`. or `r print(1)`. _32나 %32처럼 보통 fig.cap=에 쓸 수 없는 문자도 쓸 수 있나?

```{r x-fig, echo=FALSE, message=FALSE, fig.cap="(ref:x-fig)", fig.scap="This picture is for testing"}
