...
```{r nz-gg2, message=FALSE, fig.cap="Comparison of map of New Zealand created with ggplot2 alone (left) and ggplot2 and ggspatial (right).", out.width="45%", fig.show='hold', echo=FALSE, warning=FALSE, fig.height=7, eval=FALSE}

# Because of the following error, I set eval for this chunk to be FALSE
# Quitting from lines 1107-1119 [nz-gg2] (09-mapping.Rmd)
# Execution halted
# Error in Rscript_render(f, render_args, render_meta, add1, add2) : 
#   Failed to compile 09-mapping.Rmd
...
#   no applicable method for 'st_transform' applied to an object of class "function"
